...
\centering
\captionsetup{justification = centering}
\includegraphics[width=0.6\textwidth]{figures/miscellaneous/fig_distributionals.pdf}
...
In this thesis, we by default used C51 distributional TD learning on all \DQN{}-based baseline and agents. That is, the estimators output histograms instead of scalars. We regress the histogram towards the targets, where these targets are skewed histograms of scalar values, towards which KL-divergence is used to train. 
